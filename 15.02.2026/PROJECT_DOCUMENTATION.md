...
### Activity Diagram (Text Representation):
```
Start -> Login Form -> [Valid Credentials] -> Main Form -> [Choose Action]
                                      -> [Invalid] -> Error Message -> Login Form
Main Form -> View Profile -> Profile Form -> Close -> Main Form
        -> Edit Profile -> Edit Form -> Save -> Main Form
        -> Admin Panel -> Admin Form -> [Edit/Delete] -> Confirm -> Update DB -> Admin Form
        -> Logout -> Login Form
```
